...
if ($id<count($special_tasks)-1){
    $id_next = $id+1;
    $link_next = "https://math.kh.ua/special_tasks.php?id=".$id_next;
}else{
    $link_next = "https://math.kh.ua/finish.php";
}

print_r($special_tasks);

$chapter = $special_tasks[$id][0];
$n_task = $special_tasks[$id][1];;
