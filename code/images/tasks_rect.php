...
<body>
    <div class="container">
        ...
        <select name="task" id="type">
            ...
            <option value="1">Kindergarten. Rect</option>
            <option value="2">Grade 1. Quadrilaterals</option>
            <option value="3">Grade 2. Properties of rectangles</option>
            <option value="4">Grade 3. Length to area and perimeter</option>
            <option value="5">Grade 4. Area and perimeter to length</option>
            <option value="6">Grade 5. Other quadrilaterals</option>
            <option value="7">Grade 6. Coordinates </option>
            <option value="8">Grade 7. Scale</option>
            <option value="9">Grade 8. Diagonal</option>
            ...
            <option value="18">Elipses.</option>
            <option value="19">Marges</option>
            <option value="20">Bubbles</option>
    ...
    <script>
        ...
        forms_array.push("<b>In progress</b>");
        forms_array.push("<b>In progress</b>");
        forms_array.push("<b>In progress</b>");
        forms_array.push("<b>In progress</b>");
        ...
        if (v == 8){
            ...
            if (v == 17){
                ...
                src_string = `https://innovations.kh.ua/images/quadrangle.php`;
            }
            if (v == 18){
                mainPicture.innerHTML = '';
                var pic = document.createElement("img");
                ...
                src_string = `https://innovations.kh.ua/images/ellipse.php?in=4&all=10`;
            }
            if (v == 19){
                mainPicture.innerHTML = '';
                var pic = document.createElement("img");
                ...
                src_string = `https://innovations.kh.ua/images/merge.php?in=7&all=10`;
            }
            if (v == 20){
