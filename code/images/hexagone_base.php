...
class Hexagone{
    ...
    function __construct($draw){
        ...
        $x_start = 110;
        $coords = [
            array("x"=>$x_start+$n*210, "y"=>10,"name"=>'F',"angle"=>'a'),
            array("x"=>$x_start-$dx+$n*210, "y"=>10+$dy,"name"=>'E',"angle"=>'b'),
            array("x"=>$x_start-$dx+$n*210, "y"=>10+$dy+100,"name"=>'D',"angle"=>'c'),
            array("x"=>$x_start+$n*210, "y"=>10+$dy*2+100,"name"=>'C',"angle"=>'d'),
            array("x"=>$x_start+$dx+$n*210, "y"=>10+$dy+100,"name"=>'B',"angle"=>'e'),
            array("x"=>$x_start+$dx+$n*210, "y"=>10+$dy,"name"=>'A',"angle"=>'f'),
    ];
    $x1 = $coords[1]["x"];
    $y1 = $coords[1]["y"];
    $x2 = $coords[0]["x"];
