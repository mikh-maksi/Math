...
if ($x>3){$width_x = 50+$x*50+$z/2*40;
}else{$width_x = 300;}

if ($y>3){$height_y= 150+$y*40+$z/2*40;
}else{$height_y = 300;}


$imagick->newImage($width_x,$height_y, new ImagickPixel('white')); //max (x)+10, max(y)+10
...
$draw1->annotation($x_start+$x*$scale/2,$y_start+$y*$scale+$ly+5-40,$text);

$size = 10;
$draw1->setFontSize($size);
$draw1->annotation($x_start+$x*$scale/2+30,$y_start+$y*$scale+$ly+5-40-10,"2");
...
$draw4->annotation($x_start+$x*$scale/2-20 ,$y_start+$y*$scale/2+12,$v_out);
$draw4->annotation($x_start+$x*$scale/2+50 ,$y_start+$y*$scale/2+12," inch");
$size = 18;
$draw4->setFontSize($size);
$draw4->annotation($x_start+$x*$scale/2+90 ,$y_start+$y*$scale/2+12-20,"3");
