...
foreach ($arr as $key => $value){
    ...
    if ($key == 'apple'){
        for ($k=0;$k<$value;$k+=1){
            $j = $k%$col;
            $i = intdiv($k,$col);
            imagecopyresampled($back , $apple, 50+250*$n+64*$j, 100+64*$i, 0, 0, 50, 50, 64, 64);
        }
    }
    if ($key == 'banana'){
        for ($k=0;$k<$value;$k+=1){
            $j = $k%$col;
            $i = intdiv($k,$col);
            imagecopyresampled($back , $banana, 50+250*$n+64*$j, 100+64*$i, 0, 0, 50, 50, 64, 64);
        }
    }
    if ($key == 'orange'){
        for ($k=0;$k<$value;$k+=1){
            $j = $k%$col;
            $i = intdiv($k,$col);
            imagecopyresampled($back , $orange, 50+250*$n+64*$j, 100+64*$i, 0, 0, 50, 50, 64, 64);
        }
    }
