...
if (isset($_GET['base1'])){$base1 = $_GET['base1'];}else {$base1 = -1;}
if (isset($_GET['base2'])){$base2 = $_GET['base2'];}else {$base2 = -1;}
...
$p = new Trapezoid($draw,$h,$base1,$base2);
$draw = $p->out_print();
...
class Trapezoid{
    public $draw;
    function __construct($draw,$h,$base1,$base2){
        $this->draw = $draw;
        ...
        $scaled_base1 = $base1*$scale;
        $scaled_base2 = $base2*$scale;
        $scaled_h = $h*$scale;


        $x1 = $center_x-$scaled_base1/2;
        $y1 = $base_y;

        $x2 = $x1+($scaled_base1-$scaled_base2)/2;
        $y2 = $y1-$scaled_h;

        $x3 = $x2 + $scaled_base2;
        $y3 = $y2;

        $x4 = $x3+($scaled_base1-$scaled_base2)/2;
        $y4 = $base_y;
        ...
        $this->draw->annotation($center_x,$y2-2,$str);
